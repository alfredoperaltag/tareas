...
public class UsuarioController {
    ...
    public @ResponseBody Usuario login(@RequestBody Usuario usuarioJSON){
        try{
        	Usuario user = usuarioService.login(usuarioJSON);
        	return user;
        }catch (Exception ex){
            log.error("ERROR Controller: "+ex.getMessage());
            return null;
        }
	}
